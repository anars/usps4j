 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ZipCode" type="{}AddressType" maxOccurs="5"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class CityStateLookupResponse {
    ...
    protected List<AddressType> zipCode;
     ...
     *
     */
    public List<AddressType> getZipCode() {
        if(zipCode == null) {
            zipCode = new ArrayList<AddressType>();
        }
        return this.zipCode;
    }
}
